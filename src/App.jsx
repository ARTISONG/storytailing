                  ...
                  <div>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "repeat(2,1fr)", gap: 4 }}>
                      {[
                        ...
                        ["mirror", "แท่งสะท้อน", "◫"],
                        ["ribbon", "ริบบิ้นไหม", "≋"],
                        ["ribbondust", "ริบบิ้น+ฝุ่น", "✧"],
                        ["veilscallop", "ม่านโค้ง", "◡"],
                        ["veilwave", "ม่านคลื่น", "⌒"],
                        ["wave", "คลื่น", "〰"],
                        ["dots", "จุด", "⣿"],
                        ["line", "เส้นคลื่น", "◠"],
              ...
              {radialEnabled && (
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
                  ...
                  <div>
                    ...
                    <label style={{ fontSize: 13, color: "#9A948C", fontFamily: "'Sarabun'", fontWeight: 200, display: "block", marginBottom: 6, marginTop: 10 }}>
                      ความยาวเส้นรังสี ({Math.round(radialTickLength * 100)}%)
                    </label>
                    <input type="range" min={20} max={280} value={Math.round(radialTickLength * 100)}
                      onChange={e => setRadialTickLength(Number(e.target.value) / 100)}
                      style={{ width: "100%", accentColor: "#D4AF37", cursor: "pointer" }} />
                    ...
                    <label style={{ fontSize: 13, color: "#9A948C", fontFamily: "'Sarabun'", fontWeight: 200, display: "block", marginBottom: 6, marginTop: 10 }}>
                      แรงกระเพื่อม ({Math.round(radialBloom * 100)}%{radialBloom < 0.01 ? " — ปิด" : ""})
                    </label>
                    ...
                    <label style={{ fontSize: 13, color: "#9A948C", fontFamily: "'Sarabun'", fontWeight: 200, display: "block", marginBottom: 6, marginTop: 10 }}>
                      ระยะแผ่ของคลื่น ({Math.round(radialBloomSpread * 100)}%)
                    </label>
                    ...
                    <label style={{ fontSize: 13, color: "#9A948C", fontFamily: "'Sarabun'", fontWeight: 200, display: "block", marginBottom: 6, marginTop: 10 }}>
                      จำนวนระลอกคลื่น ({radialBloomRings})
                    </label>
                    <input type="range" min={1} max={20} value={radialBloomRings}
                      onChange={e => setRadialBloomRings(Number(e.target.value))}
                      style={{ width: "100%", accentColor: "#D4AF37", cursor: "pointer" }} />

                    <label style={{ fontSize: 13, color: "#9A948C", fontFamily: "'Sarabun'", fontWeight: 200, display: "block", marginBottom: 6, marginTop: 10 }}>
                      ขนาดวงกระเพื่อม ({Math.round(radialBloomSize * 100)}%)
                    </label>
